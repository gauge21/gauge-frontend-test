...
const config = {
    ...
    password: 'g@uge123', // better stored in an app setting such as process.env.DB_PASSWORD
    server: 'mysqlserver233.database.windows.net', // better stored in an app setting such as process.env.DB_SERVER
